...
lines.append("('tech1',     'pbkdf2:sha256:1000000$1juq9BKWzYkyYKCS$d3d239b61c93707ea9cab4e53c5a415152007688f867ac54a08d993cf028d2b6', 'Marco Reyes',       'technician',         'marco.reyes@example.com',    '09170000002', 'active'),")
lines.append("('tech2',     'pbkdf2:sha256:1000000$1gNzA7t1BDj164SQ$64d656ca2b533fdc0fa37619339c03147e9ee757f1c5a10e05d221fe3d4c196e', 'Liza Fernandez',    'technician',         'liza.fernandez@example.com', '09170000003', 'active'),")
...
lines.append("-- ---------------------------------------------------------------------")
lines.append("INSERT INTO technicians (user_id, full_name, contact_number, current_latitude, current_longitude, status, resolved_issues_count) VALUES")
lines.append("(2, 'Marco Reyes',    '09170000002', 14.2800000, 121.4140000, 'available', 14),")
lines.append("(3, 'Liza Fernandez',  '09170000003', 14.2750000, 121.4060000, 'busy',      9);")
lines.append("")
lines.append("-- ---------------------------------------------------------------------")
